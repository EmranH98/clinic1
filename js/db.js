 ...
 */
async function saveOperationItems(operationId, items, branchId) {
  // Reverse old stock
  ...
  // Update material_cost snapshot on operation
  const materialCost = cleanItems.reduce(
