...
function applyOpsClientFilter() {
  // Build a set of nutritionist specialist IDs from loaded profiles
  ...
  if (_opsTypeTab === 'women') {
    // Specialist ops for female / unisex patients, excluding nutritionists
    filtered = filtered.filter(o =>
      o.specialist_id && !o.doctor_id &&
      !nutritionistIds.has(o.specialist_id) &&
      o.procedure?.gender !== 'male'
    );
  } else if (_opsTypeTab === 'men') {
    // Specialist ops for male patients (incl. Men's Laser), excluding nutritionists
    filtered = filtered.filter(o =>
      o.specialist_id && !o.doctor_id &&
      !nutritionistIds.has(o.specialist_id) &&
      o.procedure?.gender === 'male'
    ...
    filtered = filtered.filter(o =>
      o.specialist_id && nutritionistIds.has(o.specialist_id)
    );
